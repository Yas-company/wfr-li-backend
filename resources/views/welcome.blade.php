    ...
    <header class="fixed w-full bg-white shadow-sm z-50">
        <div class="container mx-auto px-6 py-3 flex justify-between items-center">
            <div class="flex items-center">
                <img src="{{ asset('images/logo.jpeg') }}" alt="Tzwad Logo" class="h-10" />
            </div>
            <nav class="hidden md:flex items-center gap-8">
                <a href="#how-it-works" class="text-gray-700 hover:text-primary transition-colors">كيف يعمل</a>
                <a href="#features" class="text-gray-700 hover:text-primary transition-colors">المميزات</a>
                <a href="#suppliers" class="text-gray-700 hover:text-primary transition-colors">الموردون</a>
                <a href="#products" class="text-gray-700 hover:text-primary transition-colors">المنتجات</a>
            </nav>
    ...
    <section id="features" class="py-16">
        <div class="container mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white p-6 rounded shadow-sm border border-gray-100 fade-up">
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div class="h-96 bg-white rounded shadow-md overflow-hidden">
                    <div class="h-full w-full relative">
                        <img src="https://public.readdy.ai/gen_page/map_placeholder_1280x720.png" alt="Supplier Map"
                            class="w-full h-full object-cover object-top" />
                        <div class="absolute top-1/4 left-1/4 w-4 h-4 bg-primary rounded-full"></div>
                        <div class="absolute top-1/3 right-1/3 w-4 h-4 bg-primary rounded-full"></div>
                        <div class="absolute bottom-1/3 left-1/3 w-4 h-4 bg-primary rounded-full"></div>
                        <div class="absolute bottom-1/4 right-1/4 w-4 h-4 bg-primary rounded-full"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <div class="bg-white rounded shadow-sm overflow-hidden border border-gray-100 scale-up">
                    <div class="h-48 overflow-hidden">
                        <img src="https://readdy.ai/api/search-image?query=Fresh%20fruits%20and%20vegetables%20arranged%20neatly%20on%20a%20clean%20surface%2C%20vibrant%20colors%2C%20healthy%20food%20concept%2C%20high%20quality%20produce&width=400&height=300&seq=12346&orientation=landscape"
                            alt="المنتجات الطازجة" class="w-full h-full object-cover object-top" />
                    </div>
                    <div class="p-4">
                ...
                <div class="bg-white rounded shadow-sm overflow-hidden border border-gray-100 scale-up">
                    <div class="h-48 overflow-hidden">
                        <img src="https://readdy.ai/api/search-image?query=Various%20dairy%20products%20including%20milk%20bottles%2C%20cheese%20wheels%2C%20yogurt%20cups%20on%20a%20clean%20white%20surface%2C%20dairy%20food%20concept&width=400&height=300&seq=12347&orientation=landscape"
                            alt="منتجات الألبان" class="w-full h-full object-cover object-top" />
                    </div>
                    <div class="p-4">
                        <h3 class="text-lg font-semibold text-gray-800 mb-1">
                            منتجات الألبان
                ...
                <div class="bg-white rounded shadow-sm overflow-hidden border border-gray-100 scale-up">
                    <div class="h-48 overflow-hidden">
                        <img src="https://readdy.ai/api/search-image?query=Various%20cuts%20of%20meat%2C%20poultry%2C%20and%20seafood%20arranged%20on%20a%20clean%20surface%2C%20high%20quality%20protein%20food%20concept&width=400&height=300&seq=12348&orientation=landscape"
                            alt="اللحوم والمأكولات البحرية" class="w-full h-full object-cover object-top" />
                    </div>
                    <div class="p-4">
                        <h3 class="text-lg font-semibold text-gray-800 mb-1">
                ...
                <div class="bg-white rounded shadow-sm overflow-hidden border border-gray-100 scale-up">
                    <div class="h-48 overflow-hidden">
                        <img src="https://readdy.ai/api/search-image?query=Various%20grains%2C%20rice%2C%20pasta%2C%20and%20legumes%20in%20containers%20on%20a%20clean%20surface%2C%20staple%20food%20ingredients%20concept&width=400&height=300&seq=12349&orientation=landscape"
                            alt="الحبوب والمعكرونة" class="w-full h-full object-cover object-top" />
                    </div>
                    <div class="p-4">
                        <h3 class="text-lg font-semibold text-gray-800 mb-1">
                            الحبوب والمعكرونة
                ...
                <div class="bg-white rounded shadow-sm overflow-hidden border border-gray-100 scale-up">
                    <div class="h-48 overflow-hidden">
                        <img src="https://readdy.ai/api/search-image?query=Assorted%20baked%20goods%20including%20bread%2C%20pastries%2C%20and%20cakes%20on%20a%20clean%20surface%2C%20bakery%20food%20concept&width=400&height=300&seq=12350&orientation=landscape"
                            alt="منتجات المخابز" class="w-full h-full object-cover object-top" />
                    </div>
                    <div class="p-4">
                        <h3 class="text-lg font-semibold text-gray-800 mb-1">
                            منتجات المخابز
                ...
                <div class="bg-white rounded shadow-sm overflow-hidden border border-gray-100 scale-up">
                    <div class="h-48 overflow-hidden">
                        <img src="https://readdy.ai/api/search-image?query=Various%20beverages%20including%20bottled%20water%2C%20juices%2C%20and%20soft%20drinks%20on%20a%20clean%20surface%2C%20drinks%20concept&width=400&height=300&seq=12351&orientation=landscape"
                            alt="المشروبات" class="w-full h-full object-cover object-top" />
                    </div>
                    <div class="p-4">
                        <h3 class="text-lg font-semibold text-gray-800 mb-1">
                            المشروبات
                ...
                <div class="bg-white rounded shadow-sm overflow-hidden border border-gray-100 scale-up">
                    <div class="h-48 overflow-hidden">
                        <img src="https://readdy.ai/api/search-image?query=Various%20canned%20and%20jarred%20foods%20neatly%20arranged%20on%20a%20clean%20surface%2C%20preserved%20food%20concept&width=400&height=300&seq=12352&orientation=landscape"
                            alt="المعلبات" class="w-full h-full object-cover object-top" />
                    </div>
                    <div class="p-4">
                        <h3 class="text-lg font-semibold text-gray-800 mb-1">
                            المعلبات
                ...
                <div class="bg-white rounded shadow-sm overflow-hidden border border-gray-100 scale-up">
                    <div class="h-48 overflow-hidden">
                        <img src="https://readdy.ai/api/search-image?query=Various%20snacks%2C%20chips%2C%20nuts%2C%20and%20dried%20fruits%20on%20a%20clean%20surface%2C%20snack%20food%20concept&width=400&height=300&seq=12353&orientation=landscape"
                            alt="الوجبات الخفيفة" class="w-full h-full object-cover object-top" />
                    </div>
                    <div class="p-4">
