...
class SupplierSettingController extends Controller
{
    ...
    /**
     * Summary of getSupplierSettings
     *
     * @return \Illuminate\Http\JsonResponse
     */
    public function getSupplierSettings()
    {
        $result = $this->supplierSettingService->getSupplierSettings(Auth::user());

        return $this->successResponse(SupplierSettingResource::collection($result), __('messages.suppliers.settings_fetched'));
    }
}
